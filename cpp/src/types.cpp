...
AppType sniToAppType(const std::string& sni) {
    ...
    // Netflix (must come before Twitter — "t.co" substring matches netflix.com)
    ...
    // Microsoft (must come before Twitter — "t.co" substring matches microsoft.com)
    ...
    // Twitter/X (t.co tightened to avoid matching netflix.com, microsoft.com, etc.)
